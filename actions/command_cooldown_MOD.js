module.exports = {
	...
	subtitle: function (data) {
		...
		return `Cooldown do Comando: ${value} Segundos`;
	},
	...
	short_description: "Este mod irá restringir um comando",
	...
	<div>
		<div>
			<p>
			Feito por ${this.author}.<br>
			<span style="color: #FF0080; cursor: pointer" class="dntlink" data-url="${this.donate_url}"><b><u>Doar!</u></b></span>
			</p>
		</div>
		<div hidden style="float: left; width: 35%; padding-top: 20px;"> <<!-- todo: mensagem personalizada -->
		...
		<div style="float: left; width: 90%; padding-top: 15px;">
			Tempo:<br>
			<input id="value" class="round" type="text" placeholder="Insira os segundos aqui (eg: 60 -para 1 min)..."><br>
		</div>

		<div style="width: 35%; padding-top: 20px;">
		Se o Cooldown Estiver Ativo: <br>
		<select id="whattodo" class="round">
			<option value="0">Saltar Para a Ação</option>
			<option value="1">Ignorar as Próximas Ações</option>
			<option value="2">Fazer Nada</option>
			<option value="3">Continuar as Ações</option>
		</select>
		</div>
		<div style="width: 35%; padding-top: 20px;">
