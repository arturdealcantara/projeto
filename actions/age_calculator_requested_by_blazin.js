...
subtitle: function(data) {
	...
	return `Converter Idade do Formato: ${info[data.info]}`;
},
...
short_description: "Calcula a idade com base na entrada de aniversário e com base no formato de data selecionado.",
...
<div style="padding-top: 8px; width: 60%;">
	...
	<select id="info" class="round">
			...
			<option value="2">MM/AAAA/DD</option>
			<option value="3">DD/AAAA/MM</option>
			<option value="4">AAAA/MM/DD</option>
			<option value="5">AAAA/DD/MM</option>
	</select>
</div><br>
